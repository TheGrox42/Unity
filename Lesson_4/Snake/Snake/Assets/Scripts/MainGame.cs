...
public class MainGame : MonoBehaviour
{
    ...
    void OnGUI()
    {
        ...
        switch (gameMode) {
            case 0:
                Boolean stateBtn1 = GUI.Button(new Rect(new Vector2(posX - 100, posY), new Vector2(200, 30)), "Старт игры" );
                Boolean stateBtn2 = GUI.Button(new Rect(new Vector2(posX - 100, posY+50), new Vector2(200, 30)), "Выход" );
                if (stateBtn1)
                {
                    createSnake();
                }
            ...
            case 1:
                ...
                if(snakeL != null)
                {
                    ...
                    Rect rect = new Rect(new Vector2(posX - 20, 0), new Vector2(200, 30));
